...
public class BoardController {
    ...
    @GetMapping("/board/saveTestData")
    public String saveTestData() {
        boardService.saveTestData();
    ...
    public String boardModify(@PathVariable("id") Integer id, Board board, Model model, MultipartFile file) throws IOException {
